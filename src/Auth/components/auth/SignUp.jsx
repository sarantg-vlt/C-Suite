...
const SignUp = ({ toggleSlide }) => {
  ...
  const checkPasswordConform = (e) => {
    ...
    setForm((prevForm) => ({ ...prevForm, confirmPassword: confirmPasswordValue })); // ✅ Store confirmPassword
  ...
  const handleSignUp = async () => {
    ...
    if (allFieldsEmpty) {
      toast.warn("Please fill all the fields!", { autoClose: 3000, theme: "dark" });
      return;
    }
    ...
    if (!isValidLinkedin(form.LinkedIn)) {
      ...
      toast.error("Please enter a valid LinkedIn URL.", { autoClose: 3000, theme: "dark" });
      return;
    }
    ...
    if (form.password !== form.confirmPassword) {
      ...
      toast.error("Passwords do not match!", { autoClose: 3000, theme: "dark" });
      return;
    }
    ...
    if (newErrorArray.length > 0) {
      setErrorArray(newErrorArray);
      toast.warn("Please fill all required fields correctly!", { autoClose: 3000, theme: "dark" });
      return;
    }
    ...
    try {
      ...
      if (checkResponse?.status === 200) {
        toast.error("Email Already Exists!", { autoClose: 3000, theme: "colored" });
        return;
      }
    } catch (error) {
      if (error.response?.status === 404) {
        ...
        toast.error("Error checking email. Try again.", { autoClose: 3000, theme: "dark" });
        return;
      }
    }
    ...
    try {
      ...
      console.error("Signup error:", signupError);
      toast.error("Signup Failed. Please try again.", { autoClose: 3000, theme: "dark" });
    }
  };
  ...
  return (
    ...
    <div className="signup-container">
      <div className="signup-content">
        ...
        <h2 className="signup-title">Sign Up</h2>
        <p className="signup-subtitle">Get get started with your account</p>
        <form className="signup-form">
          <div className="input-container">
            <input
              type="text"

...
//       { field: "emergencyContact.name", message: "Please fill Emergency Contact Name field." },
//       { field: "emergencyContact.relationship", message: "Please fill Emergency Contact Relationship field." },
//       { field: "emergencyContact.phone", message: "Please fill Emergency Contact Phone field." },
//       { field: "emergencyContact.address", message: "Please fill Emergency Contact Address field." }
//     ];
    
  
//     // Check for missing required fields and return immediately if one is found
//     for (const item of requiredFields) {
//       const fieldParts = item.field.split(".");
//       let fieldValue = profileData;
...
//     // Step 2: Perform other field validations
//     const errors = [];
...
//       toast.error("Invalid Gender: Only alphabets and spaces are allowed.");
//       return;
//     }
...
//       return;
//     }
//     if (profileData.phoneNumber && !/^[6-9][0-9]{9}$/.test(profileData.phoneNumber)) {
...
//       toast.error("Invalid Emergency Contact Name: Only alphabets and spaces are allowed.");
//       return;
//     }
//     if (profileData.emergencyContact?.phone && !/^[6-9][0-9]{9}$/.test(profileData.emergencyContact?.phone || "")) {
//       toast.error("Invalid Emergency Contact Phone: Must be 10 digits and start with 6-9.");
//       return;
//     }
...
//     required
//   >
//     <option value="" disabled>Select Gender</option>  {/* Ensure the default option is selected */}

...
const Assessmentsstart = () => {
  ...
  const isAllQuestionsAnswered = sections && sections.every((section, sectionIndex) => {
    // Ensure section.questions is defined and is an array
    const sectionQuestions = Array.isArray(section.questions) ? section.questions : [];
    return sectionQuestions.every((_, questionIndex) => {
      return selectedOptions.hasOwnProperty(`${sectionIndex}-${questionIndex}`);
    });
  });
